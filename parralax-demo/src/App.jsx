        ...
        <Parralax>
          ...
          <div data-depth="0.15">
            <div className="flex w-full h-full items-center justify-end">
              <div className="h-[45%] grid w-3/5 flex items-start justify-center">
                <h3 className="uppercase text-6xl font-bold">South Indias Biggest</h3>
              </div>
            </div>
          </div>
          ...
          <div data-depth="0.1" className="w-full h-full">
            <div className="flex justify-end items-center w-full h-full">
              <div className="h-[65%] grid w-3/5 flex justify-start items-end">
                <h3 className="uppercase text-4xl font-bold">Valorant Tournament</h3>
              </div>
            </div>
          </div>
        </Parralax>
        <div className="absolute p-3 top-0 left-0 text-white h-[95%] grid w-2/5 place-items-center content-center">
          <div>
            <div className="mb-6">
              <h3 className="uppercase text-2xl font-bold">Rajagairi College of Social Sciences</h3>
              <h3 className="font-semibold">In collaboration with <span className="text-2xl tracking-widest ml-2">AKEF</span></h3>
            </div>
            <div className="bg-gradient-to-br from-red-500 to-red-300 bg-clip-text text-transparent">
              <h1 className="text-8xl ml-2">
                EUPHORIA
              </h1>
